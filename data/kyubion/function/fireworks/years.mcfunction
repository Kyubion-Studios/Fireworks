...
\
                        action:"show_text",\
\
                        value:"At the end of the year a fireworks show is shown to all players. Fireworks can have a big impact on game performance,\
 but it's a beautiful event to watch. Huh?"\
                    \
}\
                \
}\
