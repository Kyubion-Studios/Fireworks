...
value:"Selected language"\
    ...
    # Custom
        # Unselected
        execute if function #kyubion:fireworks/language run tellraw @s [\
{\
text:"→ Custom",\
color:"dark_green",\
hover_event:{\
...
value:"Custom language"\
        ...
        # Selected
        execute unless function #kyubion:fireworks/language run tellraw @s [\
{\
text:"→ Custom",\
color:"gray",\
hover_event:{\
...
click_event:{\
action:"open_url",\
"value":"https://github.com/Kyubion-Studios"\
}\
},\
{\
text:" a new language",\
