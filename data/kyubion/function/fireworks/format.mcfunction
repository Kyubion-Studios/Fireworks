...
hover_event:{\
action:"show_text",\
value:"Note: If the 24-hour format is selected,\
 an extra space may appear on the display. Fix this setting on the Separators page"\
}\
},\
{\
text:"24 \u25a1",\
...
{\
nbt:"displayLabels.ticksFormat[\
0]",\
storage:"kyubion:fireworks",\
color:"green",\
click_event:{\
action:"suggest_command",\
command:"/data modify storage kyubion:fireworks displayLabels.ticksFormat[\
0] set value "\
},\
hover_event:{\
action:"show_text",\
value:"Shown in the morning when 12-hour format is selected. If your label has non-alphanumeric characters,\
...
hover_event:{\
action:"show_text",\
value:"Shown in the afternoon when 12-hour format is selected. If your label has non-alphanumeric characters,\
 enter it in quotation marks"\
}\
},\
{\
